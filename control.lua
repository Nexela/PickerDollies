                        ...
                        if n_dist > min_dist then
                            ...
                            for _, target_corner in pairs(corners) do
                                for _, neighbour_corner in pairs(corners) do
                                    reach = math.min(reach, target_box[target_corner]:distance(
                                        neighbour_box[neighbour_corner]))
                                    if reach <= min_dist then break end
                                end
                                if reach <= min_dist then break end
                            end
                            if reach > min_dist then return false end
                        end
                    end
